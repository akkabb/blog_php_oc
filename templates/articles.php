            ...
            <main>
                ...
                <div class="article_news">
                    ...
                    <h3>
                        ...
                        <br>
                        <em>écrit le <?=$post['created_at']; ?></em>
                        <em>par :  <?= htmlspecialchars($post['created_by']); ?></em>
                    </h3>
                    ...
                    <p>
                        ...
                        <em><a href="http://localhost/p5_oc_blog/templates/details_article.php?id=<?= urlencode($post['id']) ;?>">Lire l'article</a></em>
                        <!-- <em>http://localhost/p5_oc_blog/templates/details_article.php?id=3</em> -->
                    </p>
                </div>
                <?php
                    }//The end of the loop
